...
function deleteSize(index) {
    ...
    sizeListDiv.removeChild(sizeListDiv.childNodes[numIndex]);
...
function addTopping() {
    ...
    toppingInput.name = "toppingList[#sizeListIndex#].name";
    ...
    priceInput.type = "number";
    priceInput.required = true;
    priceInput.name = "toppingList[#sizeListIndex#].price";
    newSpan.appendChild(priceInput);
    priceInput.className = "form-control form-control-lg inline-auto-w";
    priceInput.placeholder = "Price";
...
function deleteTopping(index) {
    ...
    toppingListDiv.removeChild(toppingListDiv.childNodes[numIndex]);
